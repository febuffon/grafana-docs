...
| [`grafana-flex-noc/`](grafana-flex-noc/) | Exports dos dashboards do NOC da FLEX Internet: MAPA FLEX e MAPA FLEX - STATUS CTO's (mapa geográfico de queda/atenuação de CTO via IXC x RADIUS). |
